namespace ESA.Common.Core
{
    using ESA.Common.Configuration;
    ...
    public sealed class CoreConfigurationManager
    {
        ...
        private async Task LoadCoreConfigurationAsync()
        {
            try
            {
                StorageFolder dataFolder = await Package.Current.InstalledLocation.GetFolderAsync("ESA.Common\\Configuration");
